...
//    }
    ...
    public void intpid(Token next) {
        ss.push(new Imidiate(Integer.parseInt(next.value), varType.Int, TypeAddress.Imidiate));
    }
    ...
    public void call() {
        ...
        ss.push(temp);
        memory.add3AddressCode(Operation.ASSIGN, new Imidiate(temp.num, varType.Address, TypeAddress.Imidiate), new Direct(symbolTable.getMethodReturnAddress(className, methodName), varType.Address), null);
        memory.add3AddressCode(Operation.ASSIGN, new Imidiate(memory.getCurrentCodeBlockAddress() + 2, varType.Address, TypeAddress.Imidiate), new Direct(symbolTable.getMethodCallerAddress(className, methodName), varType.Address), null);
        memory.add3AddressCode(Operation.JP, new Direct(symbolTable.getMethodAddress(className, methodName), varType.Address), null, null);
...
//        memory.saveMemory();
    ...
    public void methodReturn() {
        ...
        memory.add3AddressCode(Operation.ASSIGN, s, new Indirect(symbolTable.getMethodReturnAddress(symbolStack.peek(), methodName), varType.Address, TypeAddress.Indirect), null);
        memory.add3AddressCode(Operation.JP, new Direct(symbolTable.getMethodCallerAddress(symbolStack.peek(), methodName), varType.Address), null, null);
